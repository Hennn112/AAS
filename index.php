...
<nav class="navbar">
    <div class="navbar-logo">
        <img src="img/wikrama.jpg" alt="" class="navbar-icon"></a>
...
<section class="hero" id="home">
    ...
    <div class="content-img">
        ...
        <img src="img/Frame 18792.png" alt="" class="ekstra-img">
        <img src="img/unnamed 1.png" alt="" class="ekstra-image">
    </div>
</section>
...
<section class="banner">
        ...
        <div class="slider">
            <div class="slides">
              ...
              <div class="slide">
                <img src="img/rsz_1_gedung_1.jpg" alt="">
              </div>
              <div class="slide">
...
<section class="about-wakaf">
    ...
    <div class="container1">
        <div class="top-cards">
          <div class="card">
            <img src="img/Frame 18567.png" class="bordercard"> 
            <img src="img/hati.png" class="picbaccard1">
            <br><br>
          ...
          <div class="card">
            <img src="img/Frame 18567 (1).png" class="bordercard"> 
            <img src="img/ceklis.png" class="picbaccard2">
            <br><br>
        ...
        <div class="bottom-cards">
          <div class="card"> 
            <img src="img/Frame 18567 (2).png" class="bordercard"> 
            <img src="img/security.png" class="picbaccard3">
            <br><br>
          ...
          <div class="card">
            <img src="img/Frame 18567 (3).png" class="bordercard"> 
            <img src="img/bintang.png" class="picbaccard4">       
            <br><br>
    ...
    <div class="image-container">
        <img src="img/unsplash_lyiKExA4zQA.png" alt="Gambar">
    </div>
</section>
...
<section class="gallery" id="gallery">
    ...
    <div class="gallery-container">
        <div class="gallery-box">
            ...
            <div class="gallery-content">
                <img src="img/Rectangle 300 (1).png" alt="">
            </div>
            <div class="gallery-content">
                <img src="img/Rectangle 300 (2).png" alt="">
            </div>
            <div class="gallery-content">
                <img src="img/Rectangle 300 (3).png" alt="">
            </div>
            <div class="gallery-content">
                <img src="img/Rectangle 300 (4).png" alt="">
            </div>
